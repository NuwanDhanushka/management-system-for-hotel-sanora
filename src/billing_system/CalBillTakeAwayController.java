...
public class CalBillTakeAwayController implements Initializable {
  ...
  //  private TableColumn<?, ?> itemcode1;
    ...
    private Label ql;
     ...
     public CalBillTakeAwayController(){
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        subHomeC.funcNamelbl.setText("Billing System - TakeAway");
    ...
    public void loadTakeAwayStockTableSuggestions(KeyEvent event){
        ...
        try {           
            String qry = "Select * from take_away where " + searchBy + " LIKE '" + key + "'";
    ...
    private void calandPrint(ActionEvent event) throws Exception {
           ...
           ResultSet rs = con.createStatement().executeQuery("SELECT * From addedItems");
            ...
            ResultSet rslt = con.createStatement().executeQuery("SELECT Quantity from take_away where Itemcode='"+ItemCod+"'");
            ...
            while (rslt.next()) {
              ...
              //  int q1=Integer.parseInt(q);
                ...
                String qua1="update take_away set Quantity='"+newQuantity+"' where ItemCode='"+ItemCod+"'";
       ...
       // total1.setCellValueFactory(new PropertyValueFactory<>("tot"));
        ...
        table1.setItems(data);
            ...
            Connection con = conn.connect();
            String q = "INSERT INTO takeAwaysoldItems (cusName,Items,totPrice) values ('" + cusName + "','" +icodes+ "','" + tot + "')";
            pst = con.prepareStatement(q);
            pst.execute();
