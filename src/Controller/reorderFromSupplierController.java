...
import DataGateway.reorderDataGateway;
 ...
 * @author Nuwan
 */
public class reorderFromSupplierController implements Initializable {
    ...
    reorderDataGateway dataGateway = new reorderDataGateway();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        subHomeC.funcNamelbl.setText("Supplier & Stocks - Reorder");
    ...
    private void viewSelected() throws IOException{
        ...
        fxmlLoader.setLocation(getClass().getResource("/Interfaces/reorderStocks.fxml"));
        try {
            fxmlLoader.load();
            Parent parent = fxmlLoader.getRoot();
           reorderProductsController UpdateSController = fxmlLoader.getController();
